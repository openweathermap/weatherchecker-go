...
func TestOwmAdaptCurrentWeather(t *testing.T) {
	...
	expectation := MeasurementSchema{Data: Measurement{Humidity: float64(92), Precipitation: float64(0), Pressure: float64(1018), Temp: float64(-4.65), Wind: float64(4)}, Timestamp: time.Unix(int64(1450220400), 0)}
	result := OwmAdaptCurrentWeather(s)
...
func TestOwmAdaptForecast(t *testing.T) {
	...
	expectation := MeasurementArray{MeasurementSchema{Data: Measurement{Humidity: float64(86), Precipitation: float64(0.033), Pressure: float64(1012.72), Temp: float64(-3.98), Wind: 4.01}, Timestamp: time.Unix(1450213200, 0)}, MeasurementSchema{Data: Measurement{Humidity: float64(87), Precipitation: float64(0.058), Pressure: float64(1012.18), Temp: float64(-4.26), Wind: float64(3.77)}, Timestamp: time.Unix(int64(1450224000), 0)}}
	result := OwmAdaptForecast(s)
