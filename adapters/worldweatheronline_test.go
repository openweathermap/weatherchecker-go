...
func TestWorldweatheronlineAdaptCurrentWeather(t *testing.T) {
	...
	result := WorldweatheronlineAdaptCurrentWeather(s)
	expectation := MeasurementArray{MeasurementSchema{Data: Measurement{Humidity: float64(81), Precipitation: float64(2.5), Pressure: float64(1003), Temp: float64(5), Wind: float64(30)}, Timestamp: int64(1450955339)}}
...
func TestWorldweatheronlineAdaptForecast(t *testing.T) {
	...
	expectation := MeasurementArray{MeasurementSchema{Data: Measurement{Humidity: float64(93), Precipitation: float64(0.5), Pressure: float64(1021), Temp: float64(5), Wind: 14}, Timestamp: int64(1451001600)}, MeasurementSchema{Data: Measurement{Humidity: float64(93), Precipitation: float64(0.3), Pressure: float64(1022), Temp: float64(4), Wind: float64(19)}, Timestamp: int64(1451012400)}}
	result := WorldweatheronlineAdaptForecast(s)
