...
func TestForecastioAdaptCurrentWeather(t *testing.T) {
	...
	expectation := MeasurementArray{MeasurementSchema{Data: Measurement{Humidity: float64(92), Precipitation: float64(0.0051), Pressure: float64(1018), Temp: float64(4.433333333333332), Wind: float64(4.327354260089686)}, Timestamp: int64(1450793454)}}
	result := ForecastioAdaptCurrentWeather(s)
...
func TestForecastioAdaptForecast(t *testing.T) {
	...
	expectation := MeasurementArray{MeasurementSchema{Data: Measurement{Humidity: float64(91), Precipitation: float64(0.0051), Pressure: float64(1001.93), Temp: float64(4.4722222222222205), Wind: 4.336322869955157}, Timestamp: int64(1450792800)}, MeasurementSchema{Data: Measurement{Humidity: float64(94), Precipitation: float64(0.0053), Pressure: float64(1002.25), Temp: float64(4.266666666666667), Wind: float64(4.291479820627803)}, Timestamp: int64(1450796400)}}
	result := ForecastioAdaptForecast(s)
